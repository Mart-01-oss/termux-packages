...
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="-DBUILD_TESTING=OFF -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DQUICK_LINT_JS_USE_BUILD_TOOLS=$TERMUX_PKG_HOSTBUILD_DIR/build-tools/"
...
termux_step_host_build() {
	...
	termux_setup_cmake
	cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -S "$TERMUX_PKG_SRCDIR" -B build-tools $TERMUX_PKG_EXTRA_HOSTBUILD_CONFIGURE_ARGS
